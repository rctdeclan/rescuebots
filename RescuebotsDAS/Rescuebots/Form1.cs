...
namespace Rescuebots
{
    public partial class Form1 : Form
    {
        ...
        PictureBox[,] pictureBoxArray = new PictureBox[10, 10];
        ...
        void FillForm1WithMapValuesFrom2dArray()
        {
            for (int i = 0; i < 10; i++)
            {
                for (int j = 0; j < 10; j++)
                {
                    ...
                    PictureBox pb1 = pictureBoxArray[i, j];
                    switch (caseSwitch)
                    {
                        case 0:
                            pb1.Image = ALL_OPEN;
        ...
        public Form1()
        {
            ...
            pictureBoxArray[0,0] = pictureBox1;
            pictureBoxArray[0,1] = pictureBox2;
            pictureBoxArray[0,2] = pictureBox3;
            pictureBoxArray[0,3] = pictureBox4;
        }
